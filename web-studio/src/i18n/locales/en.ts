const en = {
  ...
  resources: {
    ...
    filePreview: {
      ...
      feishuSyncedResource: 'Feishu synced resource',
      feishuSyncedResourceTitle: 'Feishu resource bound to this folder',
      feishuSourceUrl: 'Source',
      feishuDocType: 'Type',
      feishuManagedFiles: 'Managed files',
      feishuManifestUpdatedAt: 'Updated at',
      noDirectoryContext:
